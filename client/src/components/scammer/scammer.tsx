            ...
            <div className="flex flex-1 flex-col gap-2">
                <div className="flex items-center gap-3 w-full justify-between">
                    ...
                    {showConfirmButtons && onUpdateScammerStatus && (
                        <div className="flex flex-col h-min items-end gap-1">
                            <Button
                                text=""
                ...
                {!showStatusButtons ? (
                    <div className="flex flex-col justify-start text-sm gap-1 text-gray-400">
                        ...
                        {scammer.twinAccounts && scammer.twinAccounts.length > 0 && (
                            <div>
                                <Block variant='default' title="Твинки" className="!p-1  !gap-0 !w-auto" isCollapsedInitially={scammer.twinAccounts.length > 3} canCollapse>
